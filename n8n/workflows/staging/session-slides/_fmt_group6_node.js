// FMT for Group 6 — Transition & Reflection (slides 13-15)
// v2: Targeted content, content-only (no facilitator scripts)
// Replace group_6 and 6 with actual values for each group.
