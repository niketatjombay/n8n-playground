// FMT for Group 7 — Action & Closing (slides 16-17)
// v2: Targeted content, content-only (no facilitator scripts)
// Replace group_7 and 7 with actual values for each group.
