// FMT for Group 3 — Context & Objectives (slides 6-7)
// v2: Targeted content, content-only (no facilitator scripts)
// Replace group_3 and 3 with actual values for each group.
